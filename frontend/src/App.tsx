...
type NavTab = 'home' | 'research' | 'portfolio' | 'markets' | 'insights' | 'profile' | 'settings' | 'privacy' | 'terms' | 'disclaimer' | 'contact';
...
const initialMarketAssets: MarketAsset[] = [
  { name: 'S&P 500', value: '5,432.61', change: '+0.87%', up: true, ticker: 'SPX', category: 'Indices', exchange: 'NYSE' },
  { name: 'NASDAQ', value: '17,891.43', change: '+1.24%', up: true, ticker: 'IXIC', category: 'Indices', exchange: 'NYSE' },
  { name: 'DOW', value: '38,748.90', change: '+0.51%', up: true, ticker: 'DJI', category: 'Indices', exchange: 'NYSE' },
  { name: 'NIFTY 50', value: '24,523.15', change: '-0.32%', up: false, ticker: 'NSEI', category: 'Indices', exchange: 'NSE' },
  { name: 'FTSE 100', value: '8,142.50', change: '+0.45%', up: true, ticker: 'FTSE', category: 'Indices', exchange: 'LSE' },
  { name: 'Nikkei 225', value: '38,210.00', change: '-0.78%', up: false, ticker: 'N225', category: 'Indices', exchange: 'TSE' },
  { name: 'NVIDIA', value: '128.20', change: '+3.85%', up: true, ticker: 'NVDA', category: 'Stocks', exchange: 'NYSE' },
  { name: 'Apple', value: '210.62', change: '+1.42%', up: true, ticker: 'AAPL', category: 'Stocks', exchange: 'NYSE' },
  { name: 'Microsoft', value: '415.80', change: '+0.65%', up: true, ticker: 'MSFT', category: 'Stocks', exchange: 'NYSE' },
  { name: 'Tesla', value: '187.35', change: '-1.15%', up: false, ticker: 'TSLA', category: 'Stocks', exchange: 'NYSE' },
  { name: 'Infosys', value: '1,894.20', change: '+0.25%', up: true, ticker: 'INFY', category: 'Stocks', exchange: 'NSE' },
  { name: 'Amazon', value: '189.08', change: '-0.45%', up: false, ticker: 'AMZN', category: 'Stocks', exchange: 'NYSE' },
  { name: 'BTC/USD', value: '67,412.00', change: '+2.15%', up: true, ticker: 'BTC', category: 'Crypto', exchange: '24/7' },
  { name: 'ETH/USD', value: '3,485.50', change: '+1.82%', up: true, ticker: 'ETH', category: 'Crypto', exchange: '24/7' },
  { name: 'SOL/USD', value: '142.80', change: '-2.35%', up: false, ticker: 'SOL', category: 'Crypto', exchange: '24/7' },
  { name: 'EUR/USD', value: '1.0824', change: '+0.08%', up: true, ticker: 'EURUSD', category: 'Forex', exchange: '24/5' },
  { name: 'GBP/USD', value: '1.2745', change: '-0.12%', up: false, ticker: 'GBPUSD', category: 'Forex', exchange: '24/5' },
  { name: 'USD/JPY', value: '158.42', change: '+0.32%', up: true, ticker: 'USDJPY', category: 'Forex', exchange: '24/5' },
  { name: 'GOLD', value: '2,341.80', change: '-0.18%', up: false, ticker: 'GC', category: 'Commodities', exchange: '24/5' },
  { name: 'SILVER', value: '29.42', change: '+0.75%', up: true, ticker: 'SI', category: 'Commodities', exchange: '24/5' },
  { name: 'CRUDE OIL', value: '81.25', change: '-1.05%', up: false, ticker: 'CL', category: 'Commodities', exchange: '24/5' }
];
    ...
    <div style={{ minHeight: '100vh' }}>
      ...
      <main style={{ maxWidth: '1280px', margin: '0 auto', padding: '32px 24px', display: 'flex', flexDirection: 'column', gap: '32px' }}>
        ...
        {activeNav === 'markets' && (
          <section className="animate-fade-up" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            <div>
              <div className="badge badge-emerald" style={{ marginBottom: '12px' }}>📈 Live Markets</div>
              <h2 className="font-display" style={{ fontSize: '2rem', color: 'var(--text-primary)', marginBottom: '8px' }}>Market Overview</h2>
              <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>Snapshot of key indices — click any to view real-time data & run AI research.</p>
            </div>
